...
class MyDistrictView(APIView):
    def get(self, request):
        ...
        for district in data.get('districts', []):
            ...
            print(lat_long_list)
        temp_url = f"https://api.open-meteo.com/v1/forecast?latitude={lat_long_list.get('lat')}&longitude={lat_long_list.get('long')}&hourly=temperature_2m"
        
        return Response(lat_long_list,status=status.HTTP_201_CREATED)
